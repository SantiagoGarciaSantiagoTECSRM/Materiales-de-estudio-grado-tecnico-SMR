...
>[!note]
>En el dosier [DNS] el esquema resolutivo, tiene un fallo, realmente cada vez que el resolver local solicita una resolución, no escala
>hacia el siguiente servidor, si no que regresa al sistema y reinicia la petición, esta vez sí, escalando hacia el siguiente servidor con
>concorde al requerimiento del fragmento que quede de la URL en búsqueda. El dosier no se corrigió, puesto que el propio docente, reconoció
>el error de explicación durante el transcurso de las clases. Por ello, se acepto esta resolución aunque fuera errónea tanto en el dosier
>como en el examen.
